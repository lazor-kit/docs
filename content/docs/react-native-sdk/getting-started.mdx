...
See [`useWallet` → Deferred execution](/react-native-sdk/use-wallet#authorizeanddexecute)
for the full API.
...
<Cards>
  ...
  <Card title="Troubleshooting" href="/troubleshooting"
    description="Common errors: NotAllowedError, Network request failed, 0x2, 0xbd0, deep-link mismatches." />
</Cards>
